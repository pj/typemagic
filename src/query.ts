...
import { ArrayTrilean, BooleanWithUndefined, GenerateScalarReturnType, RegisteredObject, ScalarTypes } from "./types";

export type Resolver<R, C, A, O, N extends BooleanWithUndefined, Arr extends ArrayTrilean> = {
...
export type RegisteredResolver<R, C, A, O, N extends BooleanWithUndefined, Arr extends ArrayTrilean> = 
...
// resolve function
export function query<R, A, O, N extends BooleanWithUndefined, Arr extends ArrayTrilean, C = any>(
